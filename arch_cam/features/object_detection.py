...
from features.detectors import create_detector
from features.detectors.detector_config import InputTensorEnum
from features.util.builtin import EventsPerSecond, load_labels
from features.util.image import SharedMemoryFrameManager
...
def run_detector(
    ...
    setproctitle(f"Archer.detector.{name}")
    listen()
