...
from features.config import CameraConfig
from features.ptz.autotrack import PtzMotionEstimator
from features.track import ObjectTracker
from features.types import PTZMetricsTypes
from features.util.image import intersection_over_union
...
def Archer_distance(detection: Detection, tracked_object) -> float:
...
class NorfairTracker(ObjectTracker):
    def __init__(
        ...
        self.tracker = Tracker(
            distance_function=Archer_distance,
