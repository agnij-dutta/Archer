"""Handle communication between Archer and other applications."""
...
from features.const import INSERT_MANY_RECORDINGS
from features.models import Recordings
from features.ptz.onvif import OnvifCommandEnum, OnvifController
from features.types import CameraMetricsTypes, FeatureMetricsTypes, PTZMetricsTypes
from features.util.services import restart_Archer
...
class Dispatcher:
    """Handle communication between Archer and communicators."""
