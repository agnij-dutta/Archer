...
from features.const import CLIPS_DIR
from features.events.maintainer import EventTypeEnum
from features.util.image import draw_box_with_label

logger = logging.getLogger(__name__)


class ExternalEventProcessor:
    def __init__(self, config: ArcherConfig, queue: Queue) -> None:
        self.config = config
        self.queue = queue
