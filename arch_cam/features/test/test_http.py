...
from features.models import Event, Recordings
from features.plus import PlusApi
from features.test.const import TEST_DB, TEST_DB_CLEANUPS
...
class TestHttp(unittest.TestCase):
    ...
    def test_get_event_list(self):
        app = create_app(
            ArcherConfig(**self.minimal_config),
            self.db,
            None,
            None,
            None,
    ...
    def test_config(self):
        app = create_app(
            ArcherConfig(**self.minimal_config).runtime_config(),
            self.db,
            None,
            None,
            None,
    ...
    @patch("Archer.http.stats_snapshot")
