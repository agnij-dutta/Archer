...
import features.detectors as detectors
import features.object_detection
from features.config import DetectorConfig, ModelConfig
from features.detectors import DetectorTypeEnum
from features.detectors.detector_config import InputTensorEnum
...
class TestLocalObjectDetector(unittest.TestCase):
        ...
        for det_type in detectors.api_types:
            with self.subTest(det_type=det_type):
                with patch.dict(
                    ...
                    test_obj = features.object_detection.LocalObjectDetector(
    ...
    def test_detect_raw_given_tensor_input_should_return_api_detect_raw_result(self):
        ...
        test_obj_detect = features.object_detection.LocalObjectDetector(
    ...
    @patch("Archer.object_detection.load_labels")
