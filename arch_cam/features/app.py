...
from features.comms.dispatcher import Communicator, Dispatcher
from features.comms.inter_process import InterProcessCommunicator
from features.comms.mqtt import MqttClient
from features.comms.ws import WebSocketClient
...
from features.events.audio import listen_to_audio
from features.events.cleanup import EventCleanup
from features.events.external import ExternalEventProcessor
from features.events.maintainer import EventProcessor
from features.http import create_app
from features.log import log_process, root_configurer
from features.models import Event, Recordings, RecordingsToDelete, Timeline
from features.object_detection import ObjectDetectProcess
from features.object_processing import TrackedObjectProcessor
from features.output import output_frames
from features.plus import PlusApi
from features.ptz.autotrack import PtzAutoTrackerThread
from features.ptz.onvif import OnvifController
from features.record.cleanup import RecordingCleanup
from features.record.record import manage_recordings
from features.stats import StatsEmitter, stats_init
from features.storage import StorageMaintainer
from features.timeline import TimelineProcessor
from features.types import CameraMetricsTypes, FeatureMetricsTypes, PTZMetricsTypes
from features.version import VERSION
from features.video import capture_camera, track_camera
from features.watchdog import ArcherWatchdog
...
class ArcherApp:
    ...
    def init_config(self) -> None:
        ...
        user_config = ArcherConfig.parse_file(config_file)
    ...
    def start_watchdog(self) -> None:
        self.Archer_watchdog = ArcherWatchdog(self.detectors, self.stop_event)
        self.Archer_watchdog.start()
    ...
    def start(self) -> None:
        self.init_logger()
        logger.info(f"Starting Archer ({VERSION})")
        try:
            self.ensure_dirs()
            try:
                self.init_config()
                ...
                print("***    https://docs.Archer.video/configuration/index     ***")
                print("*************************************************************")
                print("*************************************************************")
