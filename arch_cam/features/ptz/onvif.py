...
from features.config import ArcherConfig, ZoomingModeEnum
from features.types import PTZMetricsTypes
from features.util.builtin import find_by_key
...
class OnvifController:
    def __init__(
        self, config: ArcherConfig, ptz_metrics: dict[str, PTZMetricsTypes]
    ) -> None:
