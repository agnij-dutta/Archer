...
from features.config import CameraConfig, DetectConfig, ModelConfig
from features.const import ALL_ATTRIBUTE_LABELS, ATTRIBUTE_LABEL_MAP, CACHE_DIR
from features.detectors.detector_config import PixelFormatEnum
from features.log import LogPipe
from features.motion import MotionDetector
from features.motion.improved_motion import ImprovedMotionDetector
from features.object_detection import RemoteObjectDetector
from features.ptz.autotrack import ptz_moving_at_frame_time
from features.track import ObjectTracker
from features.track.norfair_tracker import NorfairTracker
from features.types import PTZMetricsTypes
from features.util.builtin import EventsPerSecond
from features.util.image import (
    FrameManager,
...
from features.util.services import listen
...
def capture_camera(name, config: CameraConfig, process_info):
    ...
    setproctitle(f"Archer.capture:{name}")
...
def track_camera(
    ...
    setproctitle(f"Archer.process:{name}")
    listen()
