...
sys.path.append("/workspace/Archer")

from features.config import ArcherConfig  # noqa: E402
from features.motion import MotionDetector  # noqa: E402
from features.object_detection import LocalObjectDetector  # noqa: E402
from features.object_processing import CameraState  # noqa: E402
from features.track.centroid_tracker import CentroidTracker  # noqa: E402
from features.util import (  # noqa: E402
    EventsPerSecond,
    SharedMemoryFrameManager,
    draw_box_with_label,
)
from features.video import (  # noqa: E402
    capture_frames,
    process_frames,
...
class ProcessClip:
    def __init__(self, clip_path, frame_shape, config: ArcherConfig):
...
def process(path, label, output, debug_path):
    ...
    for c in clips:
        ...
        Archer_config = ArcherConfig(**json_config)
